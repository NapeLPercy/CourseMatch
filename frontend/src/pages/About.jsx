...
export default function About() {
  ...
  return (
    <>
      <SEO
        title="About CourseMatch | Empowering South African Students"
        description="CourseMatch helps South African students make informed university decisions using APS scoring and AI-powered course recommendations."
        url="https://coursematchapp.co.za/about"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "AboutPage",
          name: "About CourseMatch",
          description:
            "CourseMatch is built to help South African students make informed university decisions using APS scoring and AI-powered course recommendations.",
          url: "https://coursematchapp.co.za/about",
        }}
      />
      <div className="about">
        ...
        >
          <div className="about-twin__card about-twin__card--mission">
            ...
            <h2 className="about-twin__title">
              Every student deserves a path.
            </h2>
            <p className="about-twin__text">
              Course Match is dedicated to helping South African students
              navigate the complex world of university admissions. We believe
              every student deserves to find their perfect academic path based
              on both their achievements and their passions.
            </p>
          </div>
          ...
          <div className="about-twin__card about-twin__card--what">
            ...
            <p className="about-twin__text">
              ...
              AI-powered personalisation. By analysing your matric marks
              alongside your personal strengths, interests, and career goals, we
              provide tailored course recommendations that go beyond just
        ...
        >
          <div className="about-why__inner">
            ...
            <p className="about-why__text">
              ...
              just grades. It's about finding where you'll thrive, grow, and
              build the future you envision. Course Match bridges the gap
              between qualification and aspiration.
            </p>
          </div>
        </section>
